...
public class MusicLibrary {
    ...
    private static TreeMap<String, MediaMetadataCompat> music = new TreeMap<>();
    private static HashMap<String, Integer> albumRes = new HashMap<>();
    private static HashMap<String, String> musicFileName = new HashMap<>();

    // 再生する音楽ファイルを設定する
    public static final void init(String album, List<String> musicFileNameList) {
        category = album;

        System.out.println("サイズ" + musicFileNameList.size());
        for (int i = 0 ; i < musicFileNameList.size(); i++) {
            String mediaId = String.valueOf(i);
